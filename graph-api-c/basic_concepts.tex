...
output object have been produced and commited to the address space of the program.
...
call it simulataneously and each will get its own error string back, referring to the
