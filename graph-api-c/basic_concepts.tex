...
\hrule
\caption{Predefined monoids for GraphBLAS in C. Maximum and minimum values for the various integral types are defined in {\tt stdint.h}. Floating-point infinities are defined in {\tt math.h}. The {\sf x} in {\sf UINTx} or {\sf INTx} can be one of 8, 16, 32, or 64; whereas in {\sf FPx}, it can be 32 or 64.}
...
\begin{threeparttable}
\hrule
\caption{Predefined true semirings where the additive identity is the multiplicative annihilator. The {\sf x} in {\sf UINTx} or {\sf INTx} can be one of 8, 16, 32, or 64; whereas in {\sf FPx}, it can be 32 or 64.}
...
\begin{threeparttable}
\hrule
\caption{Other useful predefined semirings that don't have a multiplicative annihilator. The {\sf x} in {\sf UINTx} or {\sf INTx} can be one of 8, 16, 32, or 64; whereas in {\sf FPx}, it can be 32 or 64.}
