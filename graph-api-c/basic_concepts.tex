...
$\mathbf{indrow}(\vector{A})$ & The set of row indices corresponding rows in $\matrix{A}$ that have stored values.  \\
$\mathbf{indcol}(\vector{A})$ & The set of column indices corresponding columns in $\matrix{A}$ that have stored values. \\
