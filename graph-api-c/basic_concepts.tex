...
space of the program. Furthermore, no additional execution time can
be charged to a completed operation and no additional errors can be
attributed to a completed operation.
...
\jose{Add discussion of errors with GrB\_wait(obj).}
