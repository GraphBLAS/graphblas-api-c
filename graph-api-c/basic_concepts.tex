...
The defined error values are shown in Table~\ref{Tab:ErrorValues}. The
errors fall into two groups: API errors (Table~\ref{Tab:ErrorValues}(a))
and execution errors (Table~\ref{Tab:ErrorValues}(b)).  An API error
...
{\sf GrB\_INDEX\_OUT\_OF\_BOUNDS} & Indices passed are larger than dimensions of matrix or vector being accessed. \\
