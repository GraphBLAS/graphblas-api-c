...
been computed and stored in memory.   We say that a GraphBLAS operation is \emph{complete} 
when the computations that implement the mathematical definition of the operation have 
finished and the values associated with that operation are available to any method that would 
...
operations that define that object. 
...
\glossItem{shape compatible} Also referred to as \emph{dimension compatible}, the relevant 
