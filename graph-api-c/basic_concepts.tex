...
same sequence in blocking mode with {\sf GrB\_wait(obj, GrB\_MATERIALIZE)} calls removed.  \scott{Should this be GrB\_COMPLETE instead?}
...
the {\sf GrB\_COMPLETE} parameter (see Table~\ref{Tab:EnumerationInputValues}(c)).  A GraphBLAS object is said to be 
