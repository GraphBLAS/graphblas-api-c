...
GraphBLAS \emph{collection} or operated on by GraphBLAS \emph{operator}.
...
Graphs can be represented in terms of matrices and the values stored these 
...
{\color{red} Like matrices and vectors, GraphBLAS semirings have domains
