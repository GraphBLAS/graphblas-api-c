...
first thread to call {\sf GrB\_finialize()}.  
It is an error for {\sf GrB\_init()} or {\sf GrB\_finialize()} to be called more than one
...
%GraphBLAS C API and that these constraints may vary from one application 
