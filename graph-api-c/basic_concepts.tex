...
{\sf GrB\_UnaryOp}    & {\sf GrB\_SCMP}       & ${\tt bool} \rightarrow {\tt bool}$                          & structural complement  \\
{\sf GrB\_UnaryOp}    & {\sf GrB\_IDENTITY\_$T$}   & $T \rightarrow T $     & identity \\
{\sf GrB\_UnaryOp}    & {\sf GrB\_AINV\_$T$}   & $T \rightarrow T $          & arithmetic inverse \\
{\sf GrB\_UnaryOp}    & {\sf GrB\_MINV\_$T$}   & $T \rightarrow T $          & multiplicative inverse \\
