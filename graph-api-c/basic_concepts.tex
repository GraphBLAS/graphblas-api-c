...
\glossItem{structural zero} Also known as an \emph{implied zero}, a \emph{structural zero} is a zero element in the GraphBLAS object that the GraphBLAS runtime implicitly recognizes as zero by not storing it. 

\glossItem{structural complement} A collection of all structural zeroes in a GraphBLAS object.
