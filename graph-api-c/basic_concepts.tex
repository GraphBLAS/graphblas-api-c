...
associated with that computation touches that object in the program's address space.   
...
the nature of the implied zero does not matter since the GraphBLAS C API treats them as elements of the matrix or vector that do not exist.
...
Section~\ref{Sec:ErrorModel}.) The GraphBLAS operation may not have completed,
