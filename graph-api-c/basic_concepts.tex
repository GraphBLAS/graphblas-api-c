...
and environment errors (Table~\ref{Tab:ErrorValues}(b)).  An API error
...
platforms and implementations.  Environment errors mean that something
went wrong during the execution of a legal GraphBLAS method invokation.
Their occurance may depend on specifics of the executing environment.
