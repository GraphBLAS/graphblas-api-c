...
$\mathbf{indrow}(\vector{A})$ & The set of column indices corresponding to the stored values of the indicated row.  \\
$\mathbf{indcol}(\vector{A})$ & The set of row indices corresponding to the stored values of the indicated column. \\
