...
{\sf GrB\_OUTP}                        & W            & 0     & {\sf GrB\_Descriptor} & {\sf GrB\_Desc\_Value} \\
{\sf GrB\_MASK}                        & W            & 1     & {\sf GrB\_Descriptor} & {\sf GrB\_Desc\_Value} \\
{\sf GrB\_INP0}                        & W            & 2     & {\sf GrB\_Descriptor} & {\sf GrB\_Desc\_Value} \\
{\sf GrB\_INP1}                        & W            & 3     & {\sf GrB\_Descriptor} & {\sf GrB\_Desc\_Value} \\ \hline
{\sf GrB\_NAMESIZE}                    & \_           & 10    & {\sf All}             & {\sf GrB\_Index}        \\ 
{\sf GrB\_NAME}                        & {\sf *}      & 11    & {\sf All}             & Null terminated char* of size {\sf GrB\_NAMESIZE} \\ 
                                       &              &       &                       & Minimum supported size of 512-bytes \\\hline
{\sf GrB\_LIBRARY\_NAME}               & \_           & 100   & {\sf Global}        & \sf 256-byte null terminated char* \\
{\sf GrB\_LIBRARY\_VER}                & \_           & 101   & {\sf Global}       & Length 3 integer array \\
{\sf GrB\_API\_VER}                    & \_           & 102   & {\sf Global}           & Length 3 integer array \\
{\sf GrB\_BLOCKING\_MODE}              & \_           & 103   & {\sf Global}         & {\sf GrB\_Mode} \\
{\sf GrB\_NTHREADS}                    & W            & 104   & {\sf Global}, {\sf GrB\_Descriptor} & {\sf GrB\_Index} \\ \hline
{\sf GrB\_STORAGE\_ORIENTATION\_HINT}  & WH           & 200   & {\sf Global}, {\sf Collection} & {\sf GrB\_ROWMAJOR}, {\sf GrB\_COLMAJOR} \\
{\sf GrB\_STORAGE\_FORMAT\_HINT}       & WH           & 201   & {\sf Collection} & {\sf GrB\_Format} \\
{\sf GrB\_ELTYPE??}                    & \_           & 202   & {\sf Collection} & {\sf GrB\_Type} \\ \hline
{\sf GrB\_INPUT1TYPE??}                & \_           & 300   & {\sf Algebraic} & {\sf GrB\_Type} \\
{\sf GrB\_INPUT2TYPE??}                & \_           & 301   & {\sf Algebraic} & {\sf GrB\_Type} \\
{\sf GrB\_OUTPUTTYPE??}                & \_           & 302   & {\sf Algebraic} & {\sf GrB\_Type} \\
{\sf GrB\_BINARYOP??}                  & \_           & 303   & {\sf GrB\_Monoid}, {\sf GrB\_Semiring} & {\sf GrB\_BinaryOp} \\
{\sf GrB\_MONOID??}                    & \_           & 304   & {\sf GrB\_Semiring} & {\sf GrB\_Monoid} \\
