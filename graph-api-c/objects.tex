...
Several fields are only {\em hints}. A GraphBLAS implementation is free to ignore a hint and
...
String handling works as follows: strings are passed as null-terminated {\sf char*} arrays to {\sf set},
which are then copied into internal data structures. On output the caller of {\sf get} passes a preallocated
{\sf char*} whose size is determined by another field ({\sf GrB\_NAMESIZE}, for instance) or is a constant.
The internal null-terminated string is then copied into this buffer, including the null character.
% TODO: REFERENCE!!!
% TODO: Discussion of String handling here?
...
which may be ignored by the implementation.}
