...
\begin{table}
    ...
    \end{center}
        ...
        however, this identity is not required.\newline
...
{\sf GrB\_COMP}      & Use the complement of the associated object. When combined \\ 
                     ...
                     & object is used without evaluating the values stored. {\color{red} {\sf GrB\_SCMP} is} \\
                     & {\color{red} equivalent, but is currently deprecated in favor of {\sf GrB\_COMP}, and may } \\
                     & {\color{red} be removed in future versions of this API.} \\
