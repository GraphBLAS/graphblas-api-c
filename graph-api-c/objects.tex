...
Some fields are read-only, such as the version number of the library, attempting to modify
these fields with {\sf set} will result in a {\sf GrB\_INVALUD\_VALUE} error.
% TODO: REFERENCE!!!

% TODO: Discussion of String impl
% TODO: Discussion of hints vs "exact" values.
...
GraphBLAS objects. Global fields are denoted by {\sf Global}.}
...
\begin{tabular}{l|l|l|l}
Field Name           & Value & Implementing Objects  & Type                   \\ \hline
{\sf GrB\_OUTP}      & 0     & {\sf GrB\_Descriptor} & {\sf GrB\_Desc\_Value} \\
{\sf GrB\_MASK}      & 1     & {\sf GrB\_Descriptor} & {\sf GrB\_Desc\_Value} \\
{\sf GrB\_INP0}      & 2     & {\sf GrB\_Descriptor} & {\sf GrB\_Desc\_Value} \\
{\sf GrB\_INP1}      & 3     & {\sf GrB\_Descriptor} & {\sf GrB\_Desc\_Value} \\ \hline
{\sf GrB\_NAMESIZE}  & 10    & {\sf All}             & {\sf GrB\_Index}        \\ 
{\sf GrB\_NAME}      & 11    & {\sf All}             & Null terminated char* of size {\sf GrB\_NAMESIZE} \\ 
                     &       &                       & Minimum supported size of 512-bytes \\\hline
{\sf GrB\_LIBRARY\_NAME} & 100 & {\sf Global}        & \sf 256-byte null terminated char* \\
{\sf GrB\_LIBRARY\_VER} & 101 & {\sf Global}       & Length 3 integer array \\
{\sf GrB\_API\_VER} & 102 & {\sf Global}           & Length 3 integer array \\
{\sf GrB\_BLOCKING\_MODE} & 103 & {\sf Global}         & {\sf GrB\_Mode} \\
{\sf GrB\_NTHREADS} & 104 & {\sf Global}, {\sf GrB\_Descriptor} & {\sf GrB\_Index} \\ \hline
{\sf GrB\_STORAGE\_ORIENTATION\_HINT} & 200 & {\sf Global}, {\sf Collection} & {\sf GrB\_ROWMAJOR}, {\sf GrB\_COLMAJOR} \\
{\sf GrB\_STORAGE\_FORMAT\_HINT} & 201 & {\sf Collection} & {\sf GrB\_Format} \\
{\sf GrB\_ELTYPE??} & 202 & {\sf Collection} & {\sf GrB\_Type} \\ \hline
{\sf GrB\_INPUT1TYPE??} & 300 & {\sf Algebraic} & {\sf GrB\_Type} \\
{\sf GrB\_INPUT2TYPE??} & 301 & {\sf Algebraic} & {\sf GrB\_Type} \\
{\sf GrB\_OUTPUTTYPE??} & 302 & {\sf Algebraic} & {\sf GrB\_Type} \\
{\sf GrB\_BINARYOP??}   & 303 & {\sf GrB\_Monoid}, {\sf GrB\_Semiring} & {\sf GrB\_BinaryOp} \\
{\sf GrB\_MONOID??}     & 304 & {\sf GrB\_Semiring} & {\sf GrB\_Monoid} \\
