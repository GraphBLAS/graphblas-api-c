...
field and object, but pass {\sf int*} as the last argument. The implementation will return
...
be called twice for {\sf void*}. The first call passes {\sf int*} to find the required
...
{\sf GrB\_ELTYPE\_CODE}                  & --- \(\mid\) ---  & 102   & {\sf Collection}                      & ENUM of {\sf GrB\_Type\_Code} \\ \hline
