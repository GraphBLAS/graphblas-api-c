...
{\sf GrB\_SCMP}      &  Use the complement of the associated object. When combined \\ 
                     &  with {\sf GrB\_STRUCTURE}, the complement of the structure of the associated \\
                     &  object is used without evaluating the values stored. This field value \\
		     &  is currently deprecated in favor of {\sf GrB\_COMP} above, and may be \\
		     &  removed in future versions of this API. \\
