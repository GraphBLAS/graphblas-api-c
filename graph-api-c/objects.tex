...
Several fields are only {\em hints}. A GraphBLAS implementation is free to ignore a hint for any
reason. 
...
{\sf GrB\_NTHREADS}                    & W                  & 104   & {\sf Global}, {\sf GrB\_Descriptor}   & {\sf GrB\_Index} \\ \hline
