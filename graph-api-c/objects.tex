...
{\sf ENUM} types use standard {\sf int} enumerations defined in {\sf C}.
...
\ref{Tab:PredefinedMonoids}, \ref{Tab:PredefinedTrueSemirings},
and~\ref{Tab:PredefinedUsefulSemirings}.
For example, the name of GrB\_INT32 type is {\tt "GrB\_INT32"} (9 characters) and the name of GrB\_MIN\_FP64 binary op
...
{\sf GrB\_OUTP\_FIELD}                 & W \(\mid\) ---     & 0     & {\sf GrB\_Descriptor}                 & ENUM of {\sf GrB\_Desc\_Value} \\
{\sf GrB\_MASK\_FIELD}                 & W \(\mid\) ---     & 1     & {\sf GrB\_Descriptor}                 & ENUM of {\sf GrB\_Desc\_Value} \\
{\sf GrB\_INP0\_FIELD}                 & W \(\mid\) ---     & 2     & {\sf GrB\_Descriptor}                 & ENUM of {\sf GrB\_Desc\_Value} \\
{\sf GrB\_INP1\_FIELD}                 & W \(\mid\) ---     & 3     & {\sf GrB\_Descriptor}                 & ENUM of {\sf GrB\_Desc\_Value} \\ \hline
...
{\sf GrB\_ELTYPE\_CODE}                  & --- \(\mid\) ---  & 102   & {\sf Collection}, {\sf Type}      & ENUM of {\sf GrB\_Type\_Code} \\ \hline
{\sf GrB\_INPUT1TYPE\_CODE}             & --- \(\mid\) ---   & 103   & {\sf Algebraic}                       & ENUM of {\sf GrB\_Type\_Code} \\
{\sf GrB\_INPUT2TYPE\_CODE}             & --- \(\mid\) ---   & 104   & {\sf Algebraic}                       & ENUM of {\sf GrB\_Type\_Code} \\
{\sf GrB\_OUTPUTTYPE\_CODE}             & --- \(\mid\) ---   & 105   & {\sf Algebraic}                       & ENUM of {\sf GrB\_Type\_Code} \\
...
{\sf GrB\_SIZE}                        & --- \(|\) ---   & 110   & {\sf Type}                            & {\sf GrB\_Scalar} (INT32) \\
\hline
\end{tabular}
\end{center}
