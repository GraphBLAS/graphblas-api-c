...
{\sf GrB\_ELTYPE}                      & --- \(\mid\) ---   & 202   & {\sf Collection}                      & {\sf GrB\_TypeEnum} \\ \hline
{\sf GrB\_INPUT1TYPE}                  & --- \(\mid\) ---   & 300   & {\sf Algebraic}                       & {\sf GrB\_TypeEnum} \\
{\sf GrB\_INPUT2TYPE}                  & --- \(\mid\) ---   & 301   & {\sf Algebraic}                       & {\sf GrB\_TypeEnum} \\
{\sf GrB\_OUTPUTTYPE}                  & --- \(\mid\) ---   & 302   & {\sf Algebraic}                       & {\sf GrB\_TypeEnum} \\
{\sf GrB\_BINARYOP}                    & --- \(\mid\) ---   & 303   & {\sf GrB\_Monoid}, {\sf GrB\_Semiring}& {\sf GrB\_BinaryOpEnum} \\
{\sf GrB\_MONOID}                      & --- \(\mid\) ---   & 304   & {\sf GrB\_Semiring}                   & {\sf GrB\_MonoidEnum} \\
{\sf GrB\_ENUM}                        & --- \(\mid\) ---   & 304   & {\sf Algebraic}, {\sf Collection}     & {\sf GrB\_INT32} \\
\hline
\end{tabular}
\end{center}
