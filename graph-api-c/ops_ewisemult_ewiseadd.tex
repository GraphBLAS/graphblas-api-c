...
\scott{I don't think semiring variant needs to be supported.}
...
GrB_info GrB_ewisemult(GrB_Vector* w, const GrB_Monoid s, const GrB_Vector u,
         const GrB_Vector v[, const GrB_Vector m[, const GrB_Descriptor d]]);
GrB_info GrB_ewisemult(GrB_Vector* w, const GrB_BinaryFunction s, const GrB_Vector u,
         const GrB_Vector v[, const GrB_Vector m[, const GrB_Descriptor d]]);
\end{verbatim}
...
\begin{verbatim}
#include "GraphBLAS.h"
GrB_info GrB_ewisemult(GrB_Matrix* C, const GrB_Semiring s, const GrB_Matrix A,
         const GrB_Matrix B[, const GrB_Matrix M[, const GrB_Descriptor d]]);
GrB_info GrB_ewisemult(GrB_Matrix* C, const GrB_Monoid s, const GrB_Matrix A,
         const GrB_Matrix B[, const GrB_Matrix M[, const GrB_Descriptor d]]);
GrB_info GrB_ewisemult(GrB_Matrix* C, const GrB_BinaryFunction s, const GrB_Matrix A,
         const GrB_Matrix B[, const GrB_Matrix M[, const GrB_Descriptor d]]);
\end{verbatim}
...
GrB_info GrB_ewiseadd(GrB_Vector* w, const GrB_Monoid s, const GrB_Vector u,
         const GrB_Vector v[, const GrB_Vector m[, const GrB_Descriptor d]])
GrB_info GrB_ewiseadd(GrB_Vector* w, const GrB_BinaryFunction s, const GrB_Vector u,
         const GrB_Vector v[, const GrB_Vector m[, const GrB_Descriptor d]])
\end{verbatim}
...
\begin{verbatim}
#include "GraphBLAS.h"
GrB_info GrB_ewiseadd(GrB_Matrix* C, const GrB_Semiring s, const GrB_Matrix A,
         const GrB_Matrix B[, const GrB_Matrix M[, const GrB_Descriptor d]]);
GrB_info GrB_ewiseadd(GrB_Matrix* C, const GrB_Monoid s, const GrB_Matrix A,
         const GrB_Matrix B[, const GrB_Matrix M[, const GrB_Descriptor d]]);
GrB_info GrB_ewiseadd(GrB_Matrix* C, const GrB_BinaryFunction s, const GrB_Matrix A,
         const GrB_Matrix B[, const GrB_Matrix M[, const GrB_Descriptor d]]);
\end{verbatim}
