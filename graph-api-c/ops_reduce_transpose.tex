...
t =
\begin{cases}
    ~~~~~~\bold{0}({\sf op}), & \mbox{if } \bold{ind}(\vector{\widetilde{u}}) = \varnothing, \\ & \\
    \bigoplus\limits_{i \in \bold{ind}(\vector{\widetilde{u}})} \vector{\widetilde{u}}(i), & \mbox{otherwise.}
\end{cases}
\]
...
t =
\begin{cases}
    ~~~~~~\bold{0}({\sf op}), & \mbox{if } \bold{ind}(\matrix{\widetilde{A}}) = \varnothing, \\ & \\
    \bigoplus\limits_{(i,j) \in \bold{ind}(\matrix{\widetilde{A}})} \matrix{\widetilde{A}}(i,j), & \mbox{otherwise.}
\end{cases}
\]
Where $\oplus = \bigodot({\sf op})$, and $\bold{0}({\sf op})$ is the identity of the monoid.
