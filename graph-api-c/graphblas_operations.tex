...
{\sf assign}       & $\matrix{C}\langle\matrix{M}\rangle(\array{i},\array{j})$ & $=$ & $\matrix{C}(\array{i},\array{j})$ & $\odotsp$ & $\matrix{A}$ \\
                   & $\vector{w}\langle\vector{m}\rangle(\array{i})$ & $=$ & $\vector{w}(\array{i})$ & $\odotsp$ & $\matrix{u}$ \\
%& & & \\
