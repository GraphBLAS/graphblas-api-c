...
{\tt GrB\_STRUCTURE} descriptor value is not set, it is 
applied to the result from the operation wherever the stored values in the mask evaluate to true.  If
...
structural complement operation applied ($\S$~\ref{Sec:Masks}) as specified in the 
