...
\item[{\sf GrB\_SUCCESS}]           operation completed successfully.
\item[{\sf GrB\_PANIC}]             unknown internal error.
\item[{\sf GrB\_OUTOFMEM}]          not enough memory available for operation \scott{is this possible?}.
...
\scott{need to add analyze vs. compute descriptors, pending final decision}
