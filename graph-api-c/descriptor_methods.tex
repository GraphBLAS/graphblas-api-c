...
\scott{TODO: in light of most recent decisions we need to revisit this list of fields.
For example, are there any valid descriptors for OUTP anymore?  Should we have a 
special field for the ACCUM parameter like we do for the mask (I have added it above)? 
Should we ditch the numbering scheme altogether and add GrB\_LHS and GrB\_RHS?}
