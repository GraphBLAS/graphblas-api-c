...
The {\sf UnaryOp\_new} method creates a new GraphBLAS unary operator $f_u = \langle \mathbf{D}({\sf d\_out}), 
...
The {\sf BinaryOp\_new} methods creates a new GraphBLAS binary operator $f_b = \langle \mathbf{D}({\sf d\_out}), 
...
The {\sf Semiring\_new} method creates a new semiring $S = \langle \bDout({\sf mul\_op}), 
