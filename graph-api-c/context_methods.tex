...
\scott{Is {\sf GrB\_Mode} really an object for which a {\sf GrB\_NULL} can be substituted?  I question our need to support a default.  Why can't we say that GrB\_Mode is an enum?}
