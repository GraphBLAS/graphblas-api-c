 ...
 */
{
  ...
  do {
    ...
    GrB_vxm(q,p,GrB_NULL,GrB_Int32AddMul,q,A,GrB_ReplCompMask); // q = # paths to nodes 
                                                                // reachable from current level
  ...
  for(int i=d-1; i>0; i--)
  {
    ...
    GrB_mxv(t3,GrB_FP32AddMul,A,t2);       // add contributions made by
