...
{\color{red} \sf GrB\_free(GrB\_Scalar*)}					& {\sf GrB\_Scalar\_free(GrB\_Vector*)} \\
...
{\color{red} \sf GrB\_wait(GrB\_Scalar)}					& {\sf GrB\_Scalar\_wait(GrB\_Vector)} \\

{\sf GrB\_wait(GrB\_Vector)}					& {\sf GrB\_Vector\_wait(GrB\_Vector)} \\
{\sf GrB\_wait(GrB\_Matrix)}					& {\sf GrB\_Matrix\_wait(GrB\_Matrix)} \\
{\sf GrB\_wait(GrB\_Descriptor)}				& {\sf GrB\_Descriptor\_wait(GrB\_Descriptor)} \\ 
\hline
