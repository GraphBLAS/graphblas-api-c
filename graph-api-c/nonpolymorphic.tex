...
{\sf GrB\_Scalar\_setElement(\ldots,\emph{other},\ldots)}	& {\sf GrB\_Scalar\_setElement\_UDT(\ldots,const void*,\ldots)} \\ \hline
...
{\sf GrB\_Scalar\_extractElement(\emph{other},\ldots)}		& {\sf GrB\_Scalar\_extractElement\_UDT(void*,\ldots)} \\ \hline
\end{tabular}
}
...
{\sf GrB\_error(const char**, const GrB\_Descriptor)}		& {\sf GrB\_Descriptor\_error(const char**, const GrB\_Descriptor)} \\ \hline
\end{tabular}
}
