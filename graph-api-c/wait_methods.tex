\subsection{{\sf wait}: Return once an object is either complete or materialized}
\label{Sec:GrB_wait}
...
\begin{itemize}[leftmargin=1.1in]
        ...
        value other than {\sf GrB\_COMPLETE}.  \scott{I think we should remove NULL as a valid option.}
\end{itemize}
