...
domains if implicit or explicit casting allows it. OK TO REMOVE}
...
\begin{itemize}
	\item[{\sf s}] ({\sf ARG0}) Semiring/monoid/function used in the vector-wise multiplication. \scott{element-wise mult?}
...
\begin{itemize}
	\item[{\sf s}] ({\sf ARG0}) Semiring/monoid/function used in the vector-wise addition. \scott{element-wise add?}
