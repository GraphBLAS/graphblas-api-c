...
a binary function and its identity.  This space or semiringic structure
...
\begin{itemize}
	\item[{\sf s}] ({\sf ARG0}) Semiring/monoid/function used in the vector-wise multiplication.
...
\begin{itemize}
	\item[{\sf s}] ({\sf ARG0}) Semiring/monoid/function used in the vector-wise addition.
...
\subsection{Create new semiring ({\sf Semiring\_new})}
...
\begin{itemize}
	...
	\item[{\sf z}] The $0$ element of the semiring.
	\item[{\sf o}] The $1$ element of the semiring.
\end{itemize}
...
\subsection{Create new monoid ({\sf Monoid\_new})}
...
\begin{itemize}
	...
	\item[{\sf z}] The $0$ element of the monoid.
\end{itemize}
