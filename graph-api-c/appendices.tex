...
\item (Issue 59) Changed specification about how reductions to scalar ({\sf GrB\_redcue}) are to be performed (to minimize dependence on monoid identity).
...
\item (Issue 55) Clarified requirements regarding distributive law.
