...
\subsection{{\sf GrB\_DENSE\_ROWMAJOR\_FORMAT}}
The {\sf GrB\_DENSE\_ROWMAJOR\_FORMAT} format indicates that a matrix will be imported
...
\subsection{{\sf GrB\_DENSE\_COLUMNMAJOR\_FORMAT}}
The {\sf GrB\_DENSE\_COLUMNMAJOR\_FORMAT} format indicates that a matrix will be imported
