...
\subparagraph{Return Value (vector version)}
...
\subparagraph{Return Value (matrix version)}
...
\subparagraph{Description (vector version)}

\subparagraph{Description (matrix version)}
