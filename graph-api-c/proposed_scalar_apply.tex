%-----------------------------------------------------------------------------
\subsection*{4.3.8 {\sf apply}: Apply a function to the elements of a container.}
...
\subsubsection*{4.3.8.5 {\sf apply}: Vector index unary operator variant\scott{NEW CONTENT}}
...
a scalar constant, {\sf val} {\color{blue} or {\sf s}}:
\begin{itemize}[leftmargin=2.1in]
    \item[~] ${\sf w} = f_{iu}({\sf u}, \bold{ind}({\sf u}), 1, {\sf val})$ {\color{blue} or ${\sf w} = f_{iu}({\sf u}, \bold{ind}({\sf u}), 1, {\sf s})$},
\end{itemize}
or if an optional binary accumulation operator ($\odot$) is provided:
\begin{itemize}[leftmargin=2.1in]
    \item[~] ${\sf w} = {\sf w} \odot f_{iu}({\sf u}, \bold{ind}({\sf u}), 1, {\sf val})$ {\color{blue} or ${\sf w} = {\sf w} \odot f_{iu}({\sf u}, \bold{ind}({\sf u}), 1, {\sf s})$}.  
\end{itemize}
...
\subsubsection*{4.3.8.6 {\sf apply}: Matrix index unary operator variant\scott{NEW CONTENT}}
...
indices, and a scalar constant, {\sf val} {\color{blue} or {\sf s}}:   
\begin{itemize}[leftmargin=2.1in]
    \item[~] ${\sf C} = f_{iu}({\sf A}, \bold{ind}({\sf A}), 2, {\sf val})$ {\color{blue} or  ${\sf C} = f_{iu}({\sf A}, \bold{ind}({\sf A}), 2, {\sf s})$},
\end{itemize}
or if an optional binary accumulation operator ($\odot$) is provided:  
\begin{itemize}[leftmargin=2.1in]
    \item[~] ${\sf C} = {\sf C} \odot f_{iu}({\sf A}, \bold{ind}({\sf A}), 2, {\sf val})$ {\color{blue} or ${\sf C} = {\sf C} \odot f_{iu}({\sf A}, \bold{ind}({\sf A}), 2, {\sf s})$}.  
\end{itemize}
}
