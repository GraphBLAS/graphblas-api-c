...
and descriptors, enables codification of the algorithm with fewer functions calls within the main loops. The 
...
The forward sweep performs {\tt nsver} simultaneous BFS traversals.  In this
...
adjacency matrix (as opposed ot its transpose). The algorithm makes sure that the BC contributions are 
