...
domains, and (ii) does not require the definition of the
...
as a well defined ordered collection of GraphBLAS method calls.  The beginning of a sequence
...
The set of operations between the initiation of a sequence and its termination mathematically defines the result of that sequence. 
