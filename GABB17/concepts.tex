...
The state of a GraphBLAS application is largely captured by collections of values, namely vectors and matrices.
The graphBLAS
...
Descriptors are always the last argument in GraphBLAS methods. They
modify the semantics of GraphBLAS methods by controlling 
optional behaviors. 
In particular, descriptors specify how other input arguments 
-- vectors, matrices and masks -- should
