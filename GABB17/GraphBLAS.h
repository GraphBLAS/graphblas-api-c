...
GrB_Info GrB_Matrix_assign_constant_FP64(GrB_Matrix, const GrB_Matrix, const GrB_BinaryOp, double, const GrB_Index*, const GrB_Index, const GrB_Index*, const GrB_Index, const GrB_Descriptor);
...
GrB_Info GrB_Column_assign(GrB_Matrix, GrB_Vector, GrB_BinaryOp, GrB_Vector, const GrB_Index*, GrB_Index, GrB_Index, GrB_Descriptor);
...
#define GrB_assign_8(C,mask,accum,u,rows,m,col,desc) GrB_Column_assign(C,mask,accum,u,rows,m,col,desc)
#define GrB_assign_9(C,Mask,accum,val,rows,m,cols,n,desc) _Generic((val), float : GrB_Matrix_assign_constant_FP32, double : GrB_Matrix_assign_constant_FP64)(C,Mask,accum,val,rows,m,cols,n,desc)
